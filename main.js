...
const showOutput = (outputValues) => {
    ...
    document.querySelector('.output-top').innerHTML = `
        ...
        Dear Mr/ Mrs. <strong> ${outputValues.name} </strong>When your Child will be at the Age of  <strong> ${outputValues.ageGoal}</strong> years You are to have <strong>${outputValues.fv1} Taka </strong>For the Event <br>
    ...
    document.querySelector('.output-middle').innerHTML = `
        ...
        Your monthly SIP is <strong> ${outputValues.pmt} Taka </strong> with lumpsum investment of <strong>${new Intl.NumberFormat('en-IN', { maximumSignificantDigits: 3 }).format(outputValues.possibleInvestment)}</strong> will bring the joy of mariage at the age of  <strong>${outputValues.ageGoal} years</strong>  <br>
